...
describe('GherkinEditor', () => {
  ...
  //       const ref: React.MutableRefObject<ReactAce> = React.createRef()
  ...
  //       ref.current.editor.setValue('Then no scenario')
  ...
  //       expect(GherkinAnnotator).toHaveBeenCalledWith(
  //         expect.anything(),
  //         onParse
  //       )
  //     })
